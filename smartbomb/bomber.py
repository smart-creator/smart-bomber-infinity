...
def banner ():#line:232:def banner():
  ...
  \__ \/ /|_/ / /| | / /_/ / / /   
 ___/ / /  / / ___ |/ _, _/ / /    
/____/_/  /_/_/  |_/_/ |_| /_/      """,'red')#line:252:""", 'red')
...
def start (OOO000OO00O000000 ,O0OOOOOOO000OOOO0 ,O0000000OOO00OOO0 ,O00OOO000OOO0O000 ,OO0O0000O0OO0O000 ):#line:407:def start(target, counter, delay, ch, cc):
    ...
    while O00O00000OO0O000O <(int (O0000O0OO0O0OOO00 )):#line:414:while success < (int(bombs)):
        ...
        try :#line:417:try:
            ...
            if OO0O0000O0OO0O000 =="91":#line:420:if cc == "91":
                ...
                if O00O00000OO0O000O >0 :#line:425:if success > 0:
                    ...
                    print ('\t\tPlease Send A Mail To smarthacker1011@gmail.com To Let Us Know...')#line:439:'\t\tPlease Send A Mail To ggspeedx29@gmail.com To Let Us Know...')
        ...
        print ("              Use this in good way !!                ")#line:451:print("              Use this for fun, not for revenge !!                ")
        print ("              This Bomber Was Created By Smart Dickson(Tamil pasanga)!!                ")#line:452:print("              This Bomber Was Created By SpeedX !!                ")
...
if nm ==0 :#line:575:if nm == 0:
    ...
    print ("              Use this for fun, some for revenge !!                ")#line:589:print("              Use this for fun, not for revenge !!                ")
    print ("              This Bomber Was edited BY SMART DICKSON cradits to owner@smart !! ")#line:590:print("              This Bomber Was edited BY BLACKLABEL cradits to owner@speedx !! ")
